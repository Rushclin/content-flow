...
const Input = forwardRef<HTMLInputElement | HTMLTextAreaElement, InputProps>(
  (
    ...
    const baseClass = twMerge(
      "w-full rounded-md border border-slate-300 text-slate-900 placeholder:text-slate-400 " +
        "focus:border-primary focus:outline-none text-sm py-2",
      prefix ? "pl-10" : "pl-2",
    ...
    return (
      <div className={twMerge("flex flex-col my-2", className)}>
        ...
        {(smallText || displayError) && (
          <small
            className={twMerge(displayError ? "text-red-500" : "text-gray-500")}
          >
