...
import { Send, Copy, Download, Star, Loader2, History, Settings, TrendingUp, Clock, FileText, Zap, Users, HelpCircle, Home, ArrowLeft } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-lg font-semibold text-gray-900">Générateur de Contenu</h1>
                  ...
                  {generatedContent ? (
                    ...
                    <div className="text-center py-12 flex-1 flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500">
                        Remplissez le formulaire et générez du contenu pour le voir ici
                      </p>
                    </div>
                  )}
                </div>
